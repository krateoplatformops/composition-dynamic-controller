...
import (
	...
	dynamicResolver "github.com/krateoplatformops/composition-dynamic-controller/internal/kubernetes/dynamic"
...
func (g *dynamicGetter) getAuth(un *unstructured.Unstructured) (httplib.AuthMethod, error) {
	...
	gr := dynamicResolver.InferGroupResource(gvr.Group, fmt.Sprintf("%sAuth", text.ToGolangName(authType.String())))
